...
if(isset($_POST['submit'])){
  ...
  $sql="insert into `docdetails`(`doc_name`,`vis_center`,`vis_date`,`vis_time`,`vac_avail`)
  values('$doc_name','$vis_center','$vis_date','$vis_time','$vac_avail')";
    ...
    <main>
        <section id="section" class="section">
            ...
            <form method="post">
                ...
                <input type="text" id="doc_name" autocomplete="off" placeholder="Doctor Name" name="doc_name" ><br><br>
                <label for="vis_center">Visiting Center:</label>
                <input type="text" id="vis_center" autocomplete="off" placeholder="Enter your center" name="vis_center"><br><br>
